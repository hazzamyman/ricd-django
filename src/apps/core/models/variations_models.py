...
class Variation(models.Model):
    ...
    funding_schedule = models.ForeignKey('FundingSchedule', related_name='variations', on_delete=models.CASCADE, verbose_name="Primary Funding Schedule", null=True, blank=True)
    funding_schedules = models.ManyToManyField('FundingSchedule', related_name='variation_changes', blank=True, help_text="Multiple FS can be affected by one variation")
    projects = models.ManyToManyField('Project', related_name='variations', blank=True)
...
class VariationFundingSchedule(models.Model):
    ...
    funding_schedule = models.ForeignKey('FundingSchedule', on_delete=models.CASCADE)
...
class VariationItem(models.Model):
    ...
    # Entity references
    funding_schedule = models.ForeignKey('FundingSchedule', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
    funding_schedules = models.ManyToManyField('FundingSchedule', related_name='+', blank=True, help_text="For multi-FS options")
    projects = models.ManyToManyField('Project', related_name='+', blank=True)
    address = models.ForeignKey('Address', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
    work = models.ForeignKey('Work', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
    council = models.ForeignKey('Council', related_name='+', null=True, blank=True, on_delete=models.SET_NULL)
...
class ProjectChangeLog(models.Model):
    ...
    project = models.ForeignKey('Project', related_name='change_logs', on_delete=models.CASCADE)
