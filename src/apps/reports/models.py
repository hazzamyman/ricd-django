...
class MonthlyTrackerItem(models.Model):
    ...
    works = models.ManyToManyField('works.Work', blank=True, related_name='monthly_tracker_items')
...
class MonthlyTracker(models.Model):
    ...
    funding_schedule = models.ForeignKey('funding.FundingSchedule', related_name='monthly_trackers', on_delete=models.CASCADE, db_index=True)
...
class MonthlyTrackerEntry(models.Model):
    ...
    work = models.ForeignKey('works.Work', null=True, blank=True, on_delete=models.CASCADE)
...
class QuarterlyReportItem(models.Model):
    ...
    order = models.PositiveIntegerField(default=0)
    is_required = models.BooleanField(default=True)
    works = models.ManyToManyField('works.Work', blank=True, related_name='quarterly_report_items')
...
class QuarterlyReport(models.Model):
    ...
    project = models.ForeignKey('projects.Project', related_name='quarterly_reports', on_delete=models.CASCADE, db_index=True)
    year = models.PositiveIntegerField(db_index=True)
...
class StageReport(models.Model):
    ...
    project = models.ForeignKey('projects.Project', related_name='stage_reports', on_delete=models.CASCADE, db_index=True)
    funding_schedule = models.ForeignKey('funding.FundingSchedule', related_name='stage_reports', on_delete=models.SET_NULL, null=True, blank=True, help_text="Funding schedule this report is linked to")
