...
class Profile(models.Model):
    ...
    council = models.ForeignKey('councils.Council', on_delete=models.SET_NULL, null=True, blank=True, related_name='users')
...
class GroupPermission(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Auto-detect group type from name if not set
