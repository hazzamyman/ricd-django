...
from apps.core.models import WorkType, WorkStepTemplate, Work
from apps.core.models import Address, Suburb
from apps.core.models import Project
from apps.core.models import FundingApproval, FundingSchedule, Delegation
...
def programbudget_list(request):
    from apps.core.models import ProgramBudget
...
def worksteptemplate_list(request):
    from apps.core.models import WorkStepTemplate
...
def worksteptemplate_edit(request, pk):
    from apps.core.models import WorkStepTemplate, WorkType
...
def notionalcost_list(request):
    from apps.core.models import NotionalCost, NotionalCostSettings
