...
urlpatterns = [
    ...
    path('maintenance/quarterly-report-groups/', views.crud_views.QuarterlyReportItemGroupListView.as_view(), name='quarterly_report_item_group_list'),
    path('maintenance/quarterly-report-groups/create/', views.crud_views.QuarterlyReportItemGroupCreateView.as_view(), name='quarterly_report_item_group_create'),
    path('maintenance/quarterly-report-groups/<int:pk>/edit/', views.crud_views.QuarterlyReportItemGroupUpdateView.as_view(), name='quarterly_report_item_group_edit'),
    path('maintenance/quarterly-report-groups/<int:pk>/delete/', views.crud_views.QuarterlyReportItemGroupDeleteView.as_view(), name='quarterly_report_item_group_delete'),
    path('maintenance/quarterly-report-groups/<int:group_pk>/items/create/', views.crud_views.QuarterlyReportItemCreateView.as_view(), name='quarterly_report_item_create'),
    path('maintenance/quarterly-report-groups/<int:group_pk>/items/<int:pk>/edit/', views.crud_views.QuarterlyReportItemUpdateView.as_view(), name='quarterly_report_item_edit'),
    path('maintenance/quarterly-report-groups/<int:group_pk>/items/<int:pk>/delete/', views.crud_views.QuarterlyReportItemDeleteView.as_view(), name='quarterly_report_item_delete'),
