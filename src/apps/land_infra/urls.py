...
urlpatterns = [
    ...
    path('development-applications/<int:app_id>/', views.development_application_detail, name='development_application_detail'),
    path('development-applications/<int:app_id>/update/', views.development_application_edit, name='development_application_edit'),
    path('development-applications/<int:app_id>/delete/', views.development_application_delete, name='development_application_delete'),
]